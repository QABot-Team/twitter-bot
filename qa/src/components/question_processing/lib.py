...
FINE_CLASSES_SYNSETS = ['abbreviation.n.01', 'formula.n.01', 'animal.n.01', 'body.n.01', 'color.n.01',
                        ...
                        'person.n.01', 'city.n.01', 'state.n.04', 'mountain.n.01', 'code.v.02', 'count.n.01',
                        'date.n.01',
                        'distance.n.01', 'money.n.01', 'rate.v.01', 'period.n.05', 'percentage.n.01', 'speed.n.01',
                        'temperature.n.01',
                        'size.n.01', 'weight.n.01', 'disease.n.01', 'entity.n.01', 'title.n.06', 'description.n.02',
                        'location.n.01',
...
def get_features(questions):
    ...
    for question in questions:
        ...
        if wh_word == "how":
            ...
            enriched_question = enriched_question + " " + str(get_head_word(doc)) + " " + str(
