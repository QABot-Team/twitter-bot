...
from components.question_processing.fit_predict import get_clf_from_disk, get_predicted_label, get_clf_name, get_key_words
...
class Question(object):
    ...
    def filter_passages(self):
        ...
        passages = filter_passages(self.passages, AnswerType[label.upper()], nlp_toolkit)
